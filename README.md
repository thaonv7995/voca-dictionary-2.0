...
Chạy lại cùng lệnh để update. Installer sẽ dừng tiến trình `voca.jar` cũ, thay file, khởi động bản mới
ở chế độ nền và trả terminal sau khi health check thành công. Log nằm tại `voca/voca.log`.
